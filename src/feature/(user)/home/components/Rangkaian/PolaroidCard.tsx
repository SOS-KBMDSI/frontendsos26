  ...
  return (
    <div
      className={`
        ...
        md:hover:scale-110 md:hover:-translate-y-[2vh]
        md:hover:rotate-0
    ...
    >
      <div className="w-[5vh] h-[6vh] z-20 bg-primary-500 flex items-start pt-[1vh] justify-center transition-all duration-300 md:hover:bg-primary-600">
        <div className="aspect-square w-[1.5vh] rounded-full bg-white transition-all duration-300 md:hover:scale-110 md:hover:bg-yellow-100"></div>
      </div>

      <div
        className="w-[38vh] -mt-[2vh] shadow-lg rounded-xl h-fit bg-white p-[2.5vh] 
                    transition-all duration-500 ease-out
                    md:hover:shadow-2xl md:hover:shadow-primary-200/50
                    group"
      >
        <h4
          className="text-center text-[2.2vh] text-primary-600 font-medium mt-[1vh]
                     transition-colors duration-300 md:group-hover:text-primary-700"
        >
          {rangkaian.title}
        </h4>
        ...
        <Button
          ...
          className="mt-[2vh] w-full h-[5vh] text-[1.8vh]
                   ...
                   md:hover:bg-primary-500 md:hover:text-white md:hover:border-primary-500
                   md:hover:shadow-lg md:hover:shadow-primary-200/50
                   transform md:hover:scale-105 active:scale-95"
        >
          <span className="transition-transform duration-300 md:group-hover:translate-x-[0.5vh]">
            Lihat Selengkapnya
          </span>
          <span className="inline-block ml-[0.5vh] transition-transform duration-300 md:group-hover:translate-x-[1vh] opacity-0 md:group-hover:opacity-100">
            →
          </span>
        </Button>
      </div>
