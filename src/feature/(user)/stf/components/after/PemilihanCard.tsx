    ...
    <div onClick={onClick} className="w-full flex justify-center items-center">
      <div
        className={`w-full p-4 flex flex-col gap-4 ${
          isActive ? "bg-primary-600 rounded-2xl" : "bg-transparent "
        }`}
      >
        <div className="bg-primary-600 rounded-2xl">
          <Image
            ...
            height={300}
            alt="Foto Caketang"
            className="w-full h-80 object-cover rounded-2xl border-8 border-primary-600"
          />
        </div>
        <div className="py-2">
          <p
            className={`text-2xl font-semibold ${
              isActive ? "text-default-white" : "text-primary-600"
            }`}
          >
            {data.nama}
          </p>
