...
const AktivitasListSection = () => {
  return (
    <div className="w-screen lg:h-screen relative">
      <div className="w-full mycontainer  flex items-center h-full relative bg-red-800 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 p-14  2xl:max-w-7xl place-content-center w-full gap-6 mx-auto">
