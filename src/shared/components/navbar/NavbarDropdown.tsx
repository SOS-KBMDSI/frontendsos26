  ...
  return (
    <div className="relative " ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-3 bg-gradient-to-r from-secondary-400 to-secondary-600 text-default-dark font-semibold cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-secondary-500 focus-visible:ring-offset-2 px-4 py-2.5 rounded-xl hover:from-secondary-500 hover:to-secondary-700 transition-all duration-200 shadow-lg hover:shadow-xl group"
        aria-haspopup="true"
      ...
      <div
        id={dropdownId}
        className={`absolute right-1/2 transform translate-x-1/2 md:right-0 md:translate-x-0 mt-2 w-64 origin-top rounded-2xl bg-white border border-gray-200 shadow-2xl ring-1 ring-black/5 transition-all duration-200 ease-out backdrop-blur-sm ${
          isOpen
